        ...
        <div className="flex flex-col gap-10 lg:flex-row px-4 lg:gap-20 2xl:gap-40 lg:mt-12">
          ...
          >
            ...
            <div className="flex flex-col items-start gap-4 px-4 pt-10 lg:px-0">
              ...
              <p className=" text-lg">
              O PARTNERSHIP é um programa de fidelidade e experiências criado para profissionais como arquitetos, engenheiros, designers e construtoras. Ele permite que você acumule pontos com as lojas parceiras e os troque por experiências exclusivas, como viagens, cruzeiros, workshops, entre outros benefícios.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-4 px-4 pt-10 lg:px-0">
              ...
              <p className=" text-lg">
              Podem participar profissionais (como arquitetos, engenheiros e designers) e construtoras que indicam projetos para lojas parceiras. Ambos acumulam pontos e têm acesso às experiênicas do programa.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-10 lg:flex-row px-4 lg:gap-20 2xl:gap-40 lg:mt-12">
          ...
          >
            ...
            <div className="flex flex-col gap-4 px-4 pt-10 lg:px-0">
              ...
              <p className=" text-lg">
              Você pode se cadastrar diretamente pelo site do PARTNERSHIP. O processo é simples e rápido, exigindo apenas o preenchimento de um formulário pelo Whatsapp.
              </p>
            </div>
        ...
        <div className="flex flex-col gap-10 lg:flex-row px-4 lg:gap-20 2xl:gap-40 lg:mt-12">
          ...
          >
            ...
            <div className="flex flex-col items-start gap-4 px-4 pt-10 lg:px-0">
              ...
              <p className=" text-lg">
              Você pode acompanhar o saldo de pontos, histórico de resgates no painel do site ou pelo Whatsapp do PARTNERSHIP. Além disso, notificações e campanhas personalizadas são enviadas por e-mail ou WhatsApp.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-10 lg:flex-row px-4 lg:gap-20 2xl:gap-40 lg:mt-12">
          ...
          >
            ...
            <div className="flex flex-col gap-4 px-4 pt-10 lg:px-0">
              ...
              <p className="text-lg">
              Você pode acessar o catálogo de experiências pelo site ou pelo Whatsapp, escolher a experiência desejada e confirmar o resgate. O processo é simples e totalmente online.
              </p>
            </div>
